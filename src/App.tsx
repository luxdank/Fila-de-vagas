            ...
            <div className="bg-white border-2 border-slate-900 shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] flex flex-col">
              ...
              <div className="p-4 border-b-2 border-slate-900 bg-slate-100 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1.5">
                  <button
                    ...
                    disabled={fila.length <= 1}
                    className="p-1.5 text-slate-700 hover:text-slate-950 border border-slate-300 hover:border-slate-900 bg-white hover:bg-slate-100 transition-colors disabled:opacity-40"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 text-rose-700 hover:text-rose-900 border border-slate-300 hover:border-rose-900 bg-white hover:bg-rose-50 transition-colors disabled:opacity-40"
                  >
              ...
              <form onSubmit={handleAdicionarParticipante} className="p-4 bg-slate-50 border-b-2 border-slate-900 flex gap-2">
                <input
                  ...
                  className="flex-1 bg-white border-2 border-slate-900 px-3 py-2 text-xs font-bold uppercase tracking-wide focus:outline-hidden focus:bg-amber-50/20 transition-all placeholder:text-slate-400 placeholder:normal-case"
                  id="add-participant-input"
                />
                <button
                  type="submit"
                  className="bg-slate-900 hover:bg-slate-800 text-white p-2 px-4 border-2 border-slate-900 font-black text-xs uppercase tracking-wider flex items-center space-x-1 transition-all active:translate-y-0.5 hover:shadow-xs shrink-0"
                    ...
                    >
                        ...
                        {editandoId === p.id ? (
                          ...
                          <div className="flex items-center space-x-2 min-w-0">
                            ...
                            <button
                              ...
                              className="opacity-0 group-hover:opacity-100 p-1 text-slate-400 hover:text-slate-900 transition-all"
                              title="Editar nome"
                            >
                      ...
                      <div className="flex items-center space-x-1 shrink-0">
                        <button
                          ...
                          disabled={index === 0}
                          className="p-1 text-slate-500 hover:text-slate-950 hover:bg-slate-100 border border-transparent hover:border-slate-300 disabled:opacity-20 transition-all"
                          title="Subir posição"
                        >
                        ...
                        <button
                          ...
                          className="p-1 text-slate-400 hover:text-rose-600 hover:bg-rose-50 border border-transparent hover:border-rose-200 transition-all"
                          title="Remover"
                        >
                          <Trash2 className="h-3.5 w-3.5" />
                        </button>
              ...
              {/* Reset Pattern queue button */}
              <div className="p-3 bg-slate-100 border-t-2 border-slate-900 flex justify-end">
                <button
                  type="button"
                  onClick={handleReiniciarFila}
                  className="w-full text-center text-xs font-bold text-slate-700 hover:text-slate-950 bg-white hover:bg-slate-50 py-2 border-2 border-slate-900 transition-all active:translate-y-0.5"
              ...
              <div className="bg-white border-2 border-slate-900 p-6 shadow-[6px_6px_0px_0px_rgba(37,99,235,1)]" id="panel-distribute-input">
                ...
                <div className="relative mb-4">
                  <input
                    ...
                    className="w-full text-4xl font-black p-4 bg-slate-100 border-2 border-slate-900 text-slate-900 focus:outline-hidden focus:bg-white transition-all [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  />
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 flex flex-col space-y-1">
                    <button
                      ...
                      className="p-1 hover:bg-slate-200 border border-slate-300 text-slate-700 transition-colors"
                    >
                ...
                <div className="flex gap-1.5 mb-5">
                  <button
                    ...
                    className="flex-1 text-center py-1 bg-slate-100 hover:bg-slate-200 text-xs font-mono font-black border border-slate-400 transition-all"
                  >
                    5 VAGAS
                  </button>
                  <button
                  ...
                  <button
                    ...
                    disabled={fila.length === 0}
                    className="text-center px-2 py-1 bg-slate-100 hover:bg-slate-200 text-xs font-bold border border-slate-400 transition-all disabled:opacity-40"
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black text-xl py-4 border-2 border-slate-900 active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] transition-all uppercase tracking-wide flex items-center justify-center space-x-2"
                  id="btn-distribuir"
                >
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <button
                    ...
                    className="bg-slate-100 hover:bg-slate-200 font-bold py-2 border-2 border-slate-900 text-xs uppercase tracking-wider text-slate-800 transition-all"
                    id="btn-limpar"
                  >
                    Limpar
                  </button>
                  <button
                    type="button"
                    onClick={handleReiniciarFila}
                    className="bg-rose-50 text-rose-700 hover:bg-rose-100 font-bold py-2 border-2 border-rose-600 text-xs uppercase tracking-wider transition-all"
              ...
              <div className="flex items-center justify-between">
                ...
                {historico.length > 0 && (
                  <button
                    ...
                    className="text-[10px] font-black text-rose-700 hover:text-rose-900 px-2 py-1 bg-rose-50 hover:bg-rose-100 border border-rose-300 uppercase transition-all"
